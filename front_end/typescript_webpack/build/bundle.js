    ...
    function Board(element, playerBoard) {
        ...
        for (var row = 0; row < 10; row++) {
            ...
            for (var column = 0; column < 10; column++) {
                cell = new Cell_1["default"](row, column);
                this.cells[row][column] = cell;
                element.appendChild(cell.element);
                $(cell.element).addData(cell.cellLocation());
            }
        }
        console.log(" board ");
        console.dir(element);
...
var Game = (function () {
    function Game() {
        ...
        this.playerBoard = new Board_1["default"]($("#playerBoard")[0]);
        this.computerBoard = new Board_1["default"]($("#computerBoard")[0]);
    }
